...
export class getUsers {
    ...
    this.app['get'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          bh = await this.sd_G93uHbQZN3q24tHI(bh, parentSpanInst);
          //appendnew_next_sd_xHdFxyoDLZpbaokP
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_xHdFxyoDLZpbaokP');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_G93uHbQZN3q24tHI(bh, parentSpanInst) {
    ...
    try {
      ...
      //appendnew_next_sd_G93uHbQZN3q24tHI
      return bh;
    } catch (e) {
  ...
  async getUsersResponse(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_11IGT83ZWJMX1b9d');
    }
  }
