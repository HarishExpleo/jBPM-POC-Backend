...
export class signupApi {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          bh = await this.sd_xwWPQMiaCvwjLoUA(bh, parentSpanInst);
          //appendnew_next_sd_pB9Z2T2nndKMlqph
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_pB9Z2T2nndKMlqph');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async sd_xwWPQMiaCvwjLoUA(bh, parentSpanInst) {
    ...
    try {
      ...
      await this.sd_V7GL03o5dew8kHRj(bh, parentSpanInst);
      //appendnew_next_sd_xwWPQMiaCvwjLoUA
      return bh;
    } catch (e) {
  ...
  async sd_V7GL03o5dew8kHRj(bh, parentSpanInst) {
    try {
      bh.web.res
        .status(200)
      ...
      return await this.errorHandler(bh, e, 'sd_V7GL03o5dew8kHRj');
    }
  }
